...
noteApp.controller('HomeCtrl', function($scope, $stateParams, $state, $auth, noteInputFormModel, $http, $uibModal, toastr, $rootScope, noteDownloadTemplateAPI, noteUploadAPI, fileUpload) {
...
noteApp.constant('noteDownloadTemplateAPI', 'api/downloadNoteTemplate');
noteApp.constant('noteUploadAPI', 'console');
